...
dropdown_options = [
    {'label': 'Yearly Period Statistics', 'value': 'Yearly Statistics'},
...
def update_input_container(selected_statistics): # The argument of the callback function comes from the component property of the Input (i.e. user selected input)
...
# Plot 4 bar chart for the effect of unemployment rate on vehicle type and sales
        unemployment_rate=recession_data.groupby(['unemployment_rate','Vehicle_Type'])['Automobile_Sales'].mean().reset_index()
        R_chart4 = dcc.Graph(
...
# Plot bar chart for average number of vehicles sold during the given year
        ...
        Y_chart3 = dcc.Graph(
                ...
                labels={'Automobile_Sales':'Average Automobile Sold'},
